...
import { Contact, Conversation, Message, QuoteRequest } from "@prisma/client";
    ...
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-1 text-sm text-gray-700">
            {conversation.contacts[0].firstName && (
              <p><span className="font-medium">Full Name:</span> {conversation.contacts[0].firstName} {conversation.contacts[0].surname}</p>
            )}
