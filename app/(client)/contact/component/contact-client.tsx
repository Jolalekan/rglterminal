...
export const metadata: Metadata = {
  ...
  description:
    "Contact Rolling Grazing Bonded Terminal in Badagry terminal, Lagos. Call +234 906 600 5911, +234 802 099 2018 or email info@rglterminal.com. Available 24/7 for your logistics needs.",
  keywords: [
          ...
          <div className="w-full lg:w-[30%]">
            ...
            >
              ...
              <div className="flex gap-4">
                <motion.a
                  href="https://www.google.com/maps/search/?api=1&query=Kilometer+26%2C+Opposite+Foreign+Affairs+Academy%2C+Ijanikin+Badagry+Expressway%2C+Lagos+Nigeria"
                  target="_blank"
