...
import { ArrowRight, Package, Warehouse, Container, Truck, Ship, Shield, Clock, Users } from 'lucide-react'
...
const ServicesPage = () => {
  ...
  const stats = [
    ...
    { number: 10500, suffix: "+", label: "Dedicated Staff" },
    { number: 300, suffix: "+", label: "Fleet Trucks" }
  ]
  ...
  const features = [
    {
      icon: Shield,
      title: "Fully Insured",
      description: "Complete protection for your cargo"
    },
    {
      icon: Clock,
    ...
    <div className="bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Why Choose <span className="text-yellow-600">Our Services</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We combine expertise, reliability, and innovation to deliver exceptional logistics solutions.
            </p>
          </motion.div>
...
//     { number: "10,500+", label: "Happy Clients" },
//     { number: "500+", label: "Dedicated Staff" },
//     { number: "300+", label: "Fleet Trucks" }
//   ]
